...
export class CommonwareIdentity {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(CommonwareIdentity.prototype);
        obj.__wbg_ptr = ptr;
        CommonwareIdentityFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CommonwareIdentityFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    get pub_key() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.commonwareidentity_pub_key(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    sign(message) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.commonwareidentity_sign(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export function create_identity() {
    ...
    return CommonwareIdentity.__wrap(ret);
}
 ...
 * @returns {CommonwareIdentity}
 */
export function identity_from_private_hex(hex_str) {
    const ptr0 = passStringToWasm0(hex_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.identity_from_private_hex(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return CommonwareIdentity.__wrap(ret[0]);
}
 ...
 * @returns {boolean}
 */
export function verify_signature(pub_key_hex, message, signature_hex) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./commonchat_core_bg.js": import0,
    };
}

const CommonwareIdentityFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_commonwareidentity_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('commonchat_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
